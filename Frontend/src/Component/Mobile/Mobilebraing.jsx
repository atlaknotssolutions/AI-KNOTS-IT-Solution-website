        ...
        <div className="md:w-1/2 flex justify-center">
          <div
            className={`relative w-60 h-[420px] 
              ...
              ${
                isDark
                  ? "bg-zinc-950 shadow-[0_20px_60px_rgba(139,107,74,0.4)] ring-1 ring-zinc-800"
                  : "bg-zinc-900 shadow-[0_20px_60px_rgba(139,107,74,0.25)] ring-1 ring-gray-300"
              }`}
          >
            {/* Screen */}
            <div
              className={`relative w-full h-full rounded-[2rem] overflow-hidden transition-colors ${
                isDark
                  ? "bg-gradient-to-br from-zinc-950 via-black to-[#3D220E]"
                  : "bg-white"
              }`}
            >
              {/* Images */}
              ...
              >
                ...
                <div className="flex justify-between text-xs uppercase tracking-wider font-medium">
                  ...
                  <button className="font-semibold text-[#D2A679] hover:text-[#D9C5B5] transition-colors">
                    Next
                  </button>
                </div>
              </div>
