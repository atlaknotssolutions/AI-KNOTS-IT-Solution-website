...
// //               className="text-[#EFE5C8] hover:underline truncate max-w-[220px] block"
// //             >
// //               {row.link}
// //             </a>
// //           ) : (
...
// //             Our <span className="text-[#EFE5C8]">Portfolio</span>
// //           </h1>
...
//               target="_blank"
//               rel="noopener noreferrer"
//               className="text-[#EFE5C8] hover:text-red-700 hover:underline truncate max-w-[180px] block text-xs"
//             >
...
const Badge = ({ name }) => {
  const styles = {
    ...
    WordPress: "bg-[#8B6B4A] text-white",
...
const PortfolioCard = ({ item, index }) => {
  ...
  return (
    <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl overflow-hidden flex flex-col group hover:border-[#F5EDE4] dark:hover:border-[#5A351A] transition-all duration-200 hover:-translate-y-0.5">
      {/* thumbnail */}
      {hasImage ? (
      ...
      <div className="p-4 flex flex-col gap-2 flex-1">
        ...
        {item.link ? (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="mt-1 inline-flex items-center gap-2 text-xs font-semibold text-[#EFE5C8] border border-[#8B6B4A] rounded-full px-3 py-1.5 w-fit hover:bg-[#8B6B4A] hover:text-white transition-colors duration-150"
          >
            Explore More
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-10">
          ...
          <p className="text-gray-400 dark:text-gray-500 text-base">
            Showcase of our latest web development, digital marketing, and IT
            projects
          </p>
        </div>
            ...
            <button
              ...
              className={`text-xs font-medium px-4 py-2 rounded-full border transition-colors ${
                activeCategory === "all"
                  ...
                  : "border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-400 bg-white dark:bg-gray-900 hover:border-[#8B6B4A]"
              }`}
            >
              All
            </button>
