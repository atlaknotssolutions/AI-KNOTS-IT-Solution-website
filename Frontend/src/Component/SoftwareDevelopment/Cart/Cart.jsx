      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            {cart.map((item) => (
              <motion.div
                ...
                className="bg-white dark:bg-gray-900 rounded-3xl p-6 shadow-xl border border-[#F5EDE4] dark:border-[#8B6B4A]/30 flex gap-6"
              >
          ...
          <div className="lg:col-span-1">
            <div className="bg-white dark:bg-gray-900 rounded-3xl p-8 sticky top-8 shadow-xl border border-[#F5EDE4] dark:border-[#8B6B4A]/30">
