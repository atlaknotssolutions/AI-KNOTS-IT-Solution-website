        ...
        <section className="relative min-h-[90vh] flex items-center justify-center px-4 sm:px-6 lg:px-8 py-20 overflow-hidden">
          ...
          >
            ...
            >
              ...
              , we deliver fast, secure, and scalable{" "}
              <HashLink
                smooth
                to="/cloudsolutions#solutions"
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                <motion.div
                  key={idx}
                  variants={fadeInUp}
                  className={`border rounded-2xl p-10 hover:shadow-2xl transition-all group ${isDark ? "bg-gray-900/70 border-[#8B6B4A]/40 hover:border-[#8B6B4A]" : "bg-white border-gray-200 hover:border-[#8B6B4A]"}`}
                >
                  <benefit.icon
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {cloudTypes.map((type, idx) => (
                <motion.div
                  ...
                  className={`rounded-2xl p-10 hover:shadow-2xl transition-all group text-center ${isDark ? "bg-gradient-to-br from-gray-900 to-black border border-[#8B6B4A]/40 hover:border-[#8B6B4A]" : "bg-white border border-gray-200 hover:border-[#8B6B4A]"}`}
                >
                  <type.icon
                    className={`w-16 h-16 mb-6 mx-auto group-hover:scale-110 transition-transform ${isDark ? "text-[#8B6B4A]" : "text-[#8B6B4A]"}`}
                  />
                  <h3
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
              {capabilities.map((cap, idx) => (
                <motion.div
                  ...
                  whileInView="visible"
                  viewport={{ once: true }}
                  className={`rounded-2xl p-8 hover:shadow-2xl transition-all group flex flex-col items-center text-center ${isDark ? "bg-gray-900/70 border border-[#8B6B4A]/40 hover:border-[#8B6B4A]" : "bg-white border border-gray-200 hover:border-[#8B6B4A]"}`}
                >
                  <cap.icon
            ...
            >
              <motion.img
                ...
                className={`rounded-2xl shadow-2xl border w-full ${isDark ? "border-[#8B6B4A]/30" : "border-gray-200"}`}
                loading="lazy"
              />
              <motion.div variants={fadeInUp}>
                ...
                >
                  Orchestrate containers effortlessly, auto-scale workloads, and deploy faster with our managed{" "}
                  <HashLink
                    smooth
                    to="/cloudsolutions#kubernetes"
                    className={serviceLink}
        ...
        >
          <div className="max-w-5xl mx-auto text-center">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              onClick={() => navigate("/contact")}
              className={`px-14 py-7 rounded-full text-2xl md:text-3xl font-black shadow-2xl transition-all ${isDark ? "bg-[#8B6B4A] text-white shadow-[#3D220E]/60 hover:shadow-[#5A351A]/80" : "bg-[#3d220e] text-white shadow-[#3D220E]/60 hover:shadow-[#5A351A]/80"}`}
            >
