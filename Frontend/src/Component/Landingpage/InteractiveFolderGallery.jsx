...
import image1 from "../../assets/Image_landingpage/image1.png";
import image2 from "../../assets/Image_landingpage/image2.jpeg";
// import image2 from "../../assets/Image_landingpage/image2.jpeg";
import image3 from "../../assets/Image_landingpage/image3.jpeg";
import image4 from "../../assets/Image_landingpage/image4.jpeg";
import image5 from "../../assets/Image_landingpage/image5.jpeg";
          ...
          >
            <div className="w-full h-full bg-gradient-to-b from-[#2a2a2a] to-[#111] rounded-2xl border border-white/20 shadow-[inset_0_2px_10px_rgba(255,255,255,0.1)] relative overflow-hidden flex items-end justify-center pb-8">
              ...
              <div className="px-5 py-2.5 bg-black rounded-lg border border-black/80 shadow-inner flex items-center justify-center backdrop-blur-md">
                <span className="text-white/50 text-sm font-medium tracking-wide">{folderName}</span>
              </div>
            </div>
          </motion.div>
        </div>
