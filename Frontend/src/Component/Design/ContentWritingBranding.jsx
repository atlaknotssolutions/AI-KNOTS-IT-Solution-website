...
export default function ContentWritingBranding()
{
  ...
  const cardClass = isDark
    ? "bg-gray-900/70 backdrop-blur-sm border border-gray-800 hover:border-[#8B6B4A]/60 rounded-2xl p-10 hover:shadow-2xl hover:shadow-[#8B6B4A]/30 transition-all group text-center"
  ...
  return (
    <>
      ...
      >
          ...
          >
            ...
            >
              <button
                ...
                className="px-12 py-6 bg-[#8B6B4A] text-white rounded-full text-xl md:text-2xl font-bold shadow-2xl shadow-[#3D220E]/60 hover:shadow-[#5A351A]/80 hover:scale-105 transition-all flex items-center gap-3 group"
              >
            ...
            <div className="flex flex-wrap justify-center gap-6">
              {industries.map((ind, idx) => (
                <motion.span
                  ...
                  ${isDark
                      ? "bg-[#3D220E]/40 border-[#8B6B4A]/50"
                      : "bg-white border-[#F5EDE4] shadow"
                    }`}
                >
        ...
        <section
          className={`py-24 px-4 sm:px-6 lg:px-8 ${isDark ? "bg-gradient-to-br from-[#3D220E]/30 to-black" : "bg-[#F5EDE4]"}`}
        >
          <div className="max-w-5xl mx-auto text-center">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              onClick={() => navigate("/contact")}
              className="px-14 py-7 bg-[#8B6B4A] text-white rounded-full text-2xl md:text-3xl font-black shadow-2xl shadow-[#3D220E]/60 hover:shadow-[#5A351A]/80 transition-all flex items-center gap-4 mx-auto"
            >
              Contact Us Today
            </motion.button>
          </div>
