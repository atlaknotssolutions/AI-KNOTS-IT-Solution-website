...
const Scene3D = () => (
  <>
    ...
    <pointLight position={[10, 10, 10]} intensity={1.3} color="#8B6B4A" />
    <pointLight position={[-10, -10, -10]} intensity={0.85} color="#9F714E" />
    <pointLight position={[0, 6, 6]} intensity={1.0} color="#D2A679" />
    <AnimatedSphere position={[-2.8, 1.8, -2.2]} color="#8B6B4A" />
    <AnimatedSphere position={[2.8, -1.6, -1.8]} color="#9F714E" />
    <AnimatedSphere position={[0.4, 2.4, 0.8]} color="#D2A679" />
    <AnimatedSphere position={[-1.2, -2.1, -3.5]} color="#3D220E" />
...
const particlesOptions = {
  ...
  particles: {
    color: { value: ["#8B6B4A", "#9F714E", "#D2A679"] },
    links: {
      color: "#8B6B4A",
      distance: 140,
      enable: true,
...
const LeaderCard = ({
  ...
  <motion.div
    ...
    className={`backdrop-blur-sm border rounded-2xl overflow-hidden shadow-xl transition-all duration-300 ${isDark ? "bg-gray-900/60 border-[#8B6B4A]/30 shadow-[#3D220E]/30" : "bg-white border-gray-200 shadow-gray-200"}`}
  >
    ...
    <div className="p-6 text-center">
      ...
      <div className="flex justify-center gap-6 mt-4">
        <a
          ...
          className={`transition-colors ${isDark ? "text-gray-400 hover:text-[#8B6B4A]" : "text-gray-500 hover:text-[#8B6B4A]"}`}
        >
          <LinkedInIcon />
        </a>
        <a
...
export default function About()
{
  ...
  const cardClass = isDark
    ? "bg-gray-900/70 border-[#8B6B4A]/40 hover:border-[#8B6B4A]/60 hover:shadow-[#3D220E]/50"
    : "bg-white border-gray-200 hover:border-[#F5EDE4] hover:shadow-xl";
    ...
    <>
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none z-0">
          <div
            className={`absolute top-20 right-0 w-96 h-96 rounded-full blur-3xl animate-pulse ${isDark ? "bg-[#8B6B4A]/20" : "bg-[#F5EDE4]/60"}`}
          />
          <div
            className={`absolute bottom-40 left-0 w-96 h-96 rounded-full blur-3xl animate-pulse delay-1000 ${isDark ? "bg-[#3D220E]/15" : "bg-[#F5EDE4]/40"}`}
          />
        </div>
        ...
        <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12 overflow-hidden">
          ...
          <div
            className={`absolute inset-0 z-20 ${isDark ? "bg-gradient-to-br from-[#3D220E]/40 via-black/60 to-black/80" : "bg-gradient-to-br from-[#F5EDE4]/70 via-white/60 to-white/80"}`}
          />
            ...
            >
              ...
              <motion.div
                ...
                className={`group p-8 rounded-3xl border backdrop-blur-sm transition-all duration-300 hover:scale-[1.02] ${isDark
                  ? "bg-gray-900/80 border-[#8B6B4A]/30 hover:border-[#9F714E]"
                  : "bg-white/90 border-[#F5EDE4] hover:border-[#9F714E]"
                  }`}
              >
              ...
              {isModalOpen && (
                ...
                >
                  <motion.div
                    ...
                    className={`border rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden ${isDark ? "bg-gray-900 border-[#8B6B4A]/30" : "bg-white border-gray-200"}`}
                  >
                    <div
        ...
        <div
          className={`relative h-96 rounded-2xl overflow-hidden border ${isDark ? "border-[#8B6B4A]/20" : "border-[#F5EDE4]"}`}
        >
          <Canvas>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <motion.div
                ...
                className={`relative rounded-2xl shadow-2xl overflow-hidden border aspect-[4/3] md:aspect-[5/4] lg:aspect-[3/2] ${isDark ? "border-[#8B6B4A]/30" : "border-gray-200"}`}
              >
                ...
                <div className="absolute bottom-4 left-0 right-0 flex justify-center gap-2.5 z-10">
                  {teamImages.map((_, idx) => (
                    <button
                      ...
                      className={`w-2.5 h-2.5 rounded-full transition-all duration-300 ${idx === activeImageIndex ? "bg-[#8B6B4A] shadow-md shadow-[#8B6B4A]/50 scale-125" : "bg-white/50 hover:bg-white/80"}`}
                    />
                  ))}
                </div>
              </motion.div>
              ...
              ].map((item, index) =>
              {
                ...
                return (
                  <motion.div
                    ...
                    ${isDark
                        ? "bg-gradient-to-br from-gray-900 to-black border-[#8B6B4A]/30"
        ...
        <section className="py-16 px-5 sm:px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <div
              className={`rounded-2xl overflow-hidden border shadow-2xl ${isDark ? "border-[#8B6B4A]/30" : "border-gray-200"}`}
            >
              <img
                src={OurTeam}
                alt="Our Team"
