        ...
        >
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            ...
            <motion.img
              ...
              className={`rounded-3xl shadow-2xl w-full object-cover border ${isDark ? "border-[#8B6B4A]/30" : "border-gray-200"}`}
            />
          </div>
        </section>
        ...
        >
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <motion.img
              ...
              className={`rounded-3xl shadow-2xl w-full object-cover border ${isDark ? "border-[#8B6B4A]/30" : "border-gray-200"} order-2 md:order-1`}
            />
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {packages.map((pkg, idx) => (
                <motion.div
                  ...
                  className={`rounded-3xl p-8 text-center transition-all ${cardClass} ${idx === 1 ? "scale-105 border-[#8B6B4A] shadow-xl" : ""
                    }`}
                >
          ...
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12">
            <div>
              <motion.img
                ...
                className={`rounded-3xl shadow-2xl w-full object-cover border mb-8 ${isDark ? "border-[#8B6B4A]/30" : "border-gray-200"}`}
              />
              <motion.img
                initial={{ opacity: 0, scale: 0.95 }}
                whileInView={{ opacity: 1, scale: 1 }}
