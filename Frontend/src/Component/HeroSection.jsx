...
const HeroScene3D = () => {
  return (
    <>
      ...
      <pointLight position={[10, 10, 10]} intensity={2} color="#8B6B4A" />
      <pointLight position={[-10, -10, -10]} intensity={1} color="#9F714E" />
      <spotLight
        position={[0, 8, 0]}
        angle={0.5}
        penumbra={1}
      ...
      {/* Tech Orbs */}
      <TechOrb position={[-3, 2, -2]} color="#8B6B4A" speed={1} />
      <TechOrb position={[3, -2, -1]} color="#9F714E" speed={1.2} />
      <TechOrb position={[0, 3, 1]} color="#D2A679" speed={0.8} />
      <TechOrb position={[-4, -1, 2]} color="#D9C5B5" speed={1.5} />
      ...
      {/* Floating Cones */}
      <FloatingCone position={[-5, 2, -3]} color="#8B6B4A" />
      <FloatingCone position={[5, -2, -2]} color="#9F714E" />
      <FloatingCone position={[2, 3, 1]} color="#D2A679" />
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-[#8B6B4A]/20 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-[#3D220E]/15 rounded-full blur-3xl animate-pulse delay-1000" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 lg:px-24 text-center">
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 bg-[#3D220E]/40 backdrop-blur-xl border border-[#8B6B4A]/30 rounded-full px-6 py-3 mb-8"
          >
            <Sparkles className="w-5 h-5 text-[#D2A679]" />
            <span className="text-[#D9C5B5] font-semibold">
          ...
          >
            ...
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-[#D2A679] via-[#9F714E] to-[#8B6B4A] animate-gradient">
              TECH EXCELLENCE
            </span>
          </motion.h1>
          ...
          >
            ...
            <span className="text-[#D2A679] font-semibold">
          ...
          >
            {[
              ...
              <motion.div
                ...
                className="flex items-center gap-2 bg-gradient-to-br from-gray-900/90 to-black/90 backdrop-blur-xl border border-[#8B6B4A]/30 rounded-full px-6 py-3"
              >
                <item.icon className="w-5 h-5 text-[#8B6B4A]" />
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="group px-10 py-5 bg-gradient-to-r from-[#3D220E] to-[#5A351A] rounded-full text-xl font-bold shadow-2xl shadow-[#3D220E]/50 transition-all duration-300 flex items-center gap-3"
            >
              Get Started Now
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="px-10 py-5 border-2 border-[#8B6B4A]/60 rounded-full text-[#D2A679] hover:bg-[#3D220E]/40 transition-all duration-300 text-xl font-semibold flex items-center gap-3 backdrop-blur-sm"
            >
              Explore Solutions
          ...
          >
            {[
              ...
              <motion.div
                key={i}
                whileHover={{ y: -5 }}
                className="bg-gradient-to-br from-gray-900/60 to-black/60 backdrop-blur-xl border border-[#8B6B4A]/30 rounded-2xl p-6 text-center"
              >
                <div className="text-4xl md:text-5xl font-black text-[#8B6B4A] mb-2">
                  {stat.num}
                </div>
      ...
      >
        <motion.div
          ...
          className="w-6 h-10 border-2 border-[#8B6B4A] rounded-full flex justify-center pt-2"
        >
          <div className="w-1.5 h-3 bg-[#8B6B4A] rounded-full" />
        </motion.div>
      </motion.div>
    </section>
  );
