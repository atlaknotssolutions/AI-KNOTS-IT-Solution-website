    ...
    return (
      ...
      >
        ...
        <div className="flex gap-4">
          ...
          <button
            onClick={() => navigate(-1)}
            className={`px-6 py-3 rounded-full font-semibold transition ${isDark ? "bg-[#3D220E]/70 hover:bg-[#3D220E] text-white" : "bg-[#F5EDE4] hover:bg-[#D9C5B5] text-[#5A351A]"}`}
          >
            Go back
          </button>
        </div>
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid gap-10 lg:grid-cols-[1.4fr_0.6fr]">
          <section>
            ...
            <div
              className={`rounded-3xl border ${isDark ? "border-[#8B6B4A]/40 bg-zinc-950/80" : "border-gray-200 bg-white shadow-sm"} p-8`}
            >
          ...
          <aside
            className={`rounded-3xl border ${isDark ? "border-[#8B6B4A]/40 bg-zinc-950/80" : "border-gray-200 bg-white shadow-sm"} p-8 flex flex-col gap-6`}
          >
            <div>
